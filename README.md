# 📡 派蒙信号台 · 实时 AI + 生物医学工程新闻聚合台

**纯前端 · 零依赖 · 无服务器 · 无追踪 · 中英双语** —— 一个开着就能用的实时新闻信号台，由 GitHub Actions + GitHub Pages 驱动。由 AI SIGNAL（[JosiahBristow/ai-signal](https://github.com/JosiahBristow/ai-signal)）定制而来，专为旅行者（生物医学工程专业学生）加了**生物医学工程板块**。
