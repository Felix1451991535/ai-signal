...
(function () {
  ...
  var I18N = {
    ...
    "内容由 派蒙信号台 于 15 分钟快照周期内抓取，版权归原作者所有 · 以原文为准": {
      zh: "内容由 派蒙信号台 于 15 分钟快照周期内抓取，版权归原作者所有 · 以原文为准",
      en: "Content snapshotted by 派蒙信号台 within a 15-min cycle; rights belong to original authors · Original is authoritative"
    },
    /* 来源状态 */
    ...
    "派蒙信号台 是一个纯前端实时新闻聚合器，无服务器、无追踪。默认每 5 分钟自动刷新，切回页面时立即同步。所有内容版权归原网站所有，本站仅聚合链接与摘要。": {
      zh: "派蒙信号台 是一个纯前端实时新闻聚合器，无服务器、无追踪。默认每 5 分钟自动刷新，切回页面时立即同步。所有内容版权归原网站所有，本站仅聚合链接与摘要。",
      en: "派蒙信号台 is a serverless, track-free real-time news aggregator. Auto-refreshes every 5 minutes and syncs instantly on tab focus. All content belongs to the original sites; we only aggregate links and summaries."
    },
    /* 导航页 */
